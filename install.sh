...
echo -e "[INSTALL][ARGS] MATERIALX VERSION: ${MATERIALX_VERSION}"
...
# We install MaterialX.
echo -e "\n"
echo -e "[INSTALL] Installing MaterialX-${MATERIALX_VERSION}..."
echo -e "\n"
...
echo -e "\n"
echo -e "[INSTALL] Finished installing MaterialX-${MATERIALX_VERSION}!"
echo -e "\n"
